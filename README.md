...
- 사용자는 신체 부위를 선택하고 해당하는 증상을 선택 시, 진료과가 정해집니다.
...
- 사용자는 직관적으로 자신의 현재 위치 주변의 병원들을 마커로 확인할 수 있습니다.
- 또한 각각의 병원들의 주요 정보를 열람할 수 있습니다.
...
- 사용자가 증상 버튼을 누르거나 채팅으로 증상을 작성 시, 해당 정보를 파라미터 값으로 전달하여 OpenAI API를 호출합니다.
...
- OpenAI API를 활용하여 자가 진단을 도와주는 챗봇을 구현하였습니다.
- 우측 상단 챗봇 버튼을 통해 활성화 및 비활성화할 수 있습니다.
- 정확한 진료과만 선별될 수 있도록 프롬프트를 지정하였습니다.
- 사용자는 버튼 또는 채팅을 통해 자신의 증상 정보를 파라미터 값으로 전달합니다.
